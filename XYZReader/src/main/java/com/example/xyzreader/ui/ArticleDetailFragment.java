...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            mSupportActionBar.setTitle(mCursor.getString(ArticleLoader.Query.TITLE));
            ...
            bodyView.setText(Html.fromHtml(mCursor.getString(ArticleLoader.Query.BODY).substring(0, 10000).replaceAll("(\r\n|\n)", "<br />")));
            ...
            mSupportActionBar.setTitle("N/A");
